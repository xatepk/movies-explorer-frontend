      ...
      <div className="about-me__container">
        <div className="about-me__bio">
          ...
          <ul className="about-me__list">
            <li className="about-me__item"><a className="about-me__link" href="https://ru-ru.facebook.com/">Facebook</a></li>
            <li className="about-me__item"><a className="about-me__link" href="https://github.com/xatepk">Github</a></li>
          </ul>
        </div>
